...
inline bool gender_type_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, gender_type* value) {
...
class personal_info PROTOBUF_FINAL :
 ...
 public:
  ...
  bool has_phone_num() const;
  private:
  bool _internal_has_phone_num() const;
  public:
...
// optional uint32 id = 1;
inline bool personal_info::_internal_has_id() const {
...
// optional string name = 2;
inline bool personal_info::_internal_has_name() const {
...
// optional uint32 age = 3;
inline bool personal_info::_internal_has_age() const {
...
// optional .Tom.gender_type gender = 4;
inline bool personal_info::_internal_has_gender() const {
...
inline void personal_info::_internal_set_gender(::Tom::gender_type value) {
  assert(::Tom::gender_type_IsValid(value));
  _has_bits_[0] |= 0x00000010u;
  gender_ = value;
}
...
// optional uint64 phone_num = 5;
inline bool personal_info::_internal_has_phone_num() const {
  bool value = (_has_bits_[0] & 0x00000008u) != 0;
  return value;
}
inline bool personal_info::has_phone_num() const {
  return _internal_has_phone_num();
}
